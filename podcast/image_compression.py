...
def compress_imgs(
    ...
    """Compresses all PNG images in a directory.

    Args:
        img_dir: Directory containing the images to compress.
        save_dir: Directory to save the compressed images.
        quality: Compression quality (0-100).
    """
...
def upload_imgs(img_dir: str = "./images", remote_folder: str = "podcast"):
    ...
    Args:
        img_dir: Directory containing the images to upload.
...
r"""
python -m podcast.image_compression compress_img images/0_123.png
python -m podcast.image_compression upload_imgs
"""
